...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-background via-background to-secondary/20 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center justify-center text-center space-y-6 md:space-y-8 animate-fadeInUp">
          {/* Large Hero Logo */}
            <div className="animate-float animate-glow">
              <img
                src={YaredLogo}
                alt="Yared Graphics"
                className="h-32 w-auto md:h-48 mx-auto drop-shadow-lg animate-float"
          ...
          <div className="space-y-4">
            ...
            <p className="tagline text-3xl md:text-5xl text-primary font-light text-glow">
          ...
          <div className="max-w-2xl mx-auto animate-slideInLeft" style={{ animationDelay: "0.2s" }}>
            <div className="bg-card text-card-foreground rounded-3xl p-8 md:p-10 shadow-lg border border-border/50 hover-lift">
          ...
          <div className="animate-slideInRight" style={{ animationDelay: "0.4s" }}>
            <Button
              ...
              className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 rounded-full text-lg font-semibold group hover-glow transition-all"
            >
              Contact Now
